...
//             var values = this.Manager.GetBuffer<ConditionComparisonValue>(comparisonEntity);
...
//         {
//             var comparisonEntity = this.CreateComparisonValuesEntity(100);
//
//             var subscriberEntity = this.Manager.CreateEntity(typeof(ConditionActive));
...
//             };
//
//             var comparisonValues = this.Manager.GetBuffer<ConditionComparisonValue>(comparisonEntity);
//             ReactionUtil.WriteState(subscriber, comparisonValues, 100, conditionActives, conditionValues);
//
...
//         {
//             var comparisonEntity = this.CreateComparisonValuesEntity(50);
//
//             var subscriberEntity = this.Manager.CreateEntity(typeof(ConditionActive));
//             this.Manager.SetComponentData(subscriberEntity, new ConditionActive { Value = new BitArray32(0) });
//             var valuesBuffer = this.Manager.AddBuffer<ConditionValues>(subscriberEntity);
...
//
//             var comparisonValues = this.Manager.GetBuffer<ConditionComparisonValue>(comparisonEntity);
//             ReactionUtil.WriteState(subscriber, comparisonValues, 75, conditionActives, conditionValues);
//
//             var activeData = this.Manager.GetComponentData<ConditionActive>(subscriberEntity);
...
//         {
//             var comparisonEntity = this.CreateComparisonValuesEntity(25);
//
//             var subscriberEntity = this.Manager.CreateEntity(typeof(ConditionActive));
//             this.Manager.SetComponentData(subscriberEntity, new ConditionActive { Value = new BitArray32(0) });
//             var valuesBuffer = this.Manager.AddBuffer<ConditionValues>(subscriberEntity);
...
//
//             var comparisonValues = this.Manager.GetBuffer<ConditionComparisonValue>(comparisonEntity);
//             ReactionUtil.WriteState(subscriber, comparisonValues, 25, conditionActives, conditionValues);
//
//             var activeData = this.Manager.GetComponentData<ConditionActive>(subscriberEntity);
...
//         {
//             var comparisonEntity = this.CreateComparisonValuesEntity(33);
//
//             var subscriberEntity = this.Manager.CreateEntity(typeof(ConditionActive));
...
//
//             var comparisonValues = this.Manager.GetBuffer<ConditionComparisonValue>(comparisonEntity);
//             ReactionUtil.WriteState(subscriber, comparisonValues, 33, conditionActives, conditionValues);
//
//             var activeData = this.Manager.GetComponentData<ConditionActive>(subscriberEntity);
...
//         {
//             var comparisonEntity = this.CreateComparisonValuesEntity(77);
//
//             var subscriberEntity = this.Manager.CreateEntity(typeof(ConditionActive));
...
//
//             var comparisonValues = this.Manager.GetBuffer<ConditionComparisonValue>(comparisonEntity);
//             ReactionUtil.WriteState(subscriber, comparisonValues, 88, conditionActives, conditionValues);
//
//             var activeData = this.Manager.GetComponentData<ConditionActive>(subscriberEntity);
