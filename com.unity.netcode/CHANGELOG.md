...
* Netcode package now lives as a built-in editor package. This means that Changelog entries won't be available through this file but rather through editor release notes.

## [6.5.0] - 2026-02-05

* Netcode package moved to be a built-in editor package from 6000.5 editor version. This means that Changelog entries won't be available through this file but rather through editor release notes as in (for example) https://unity.com/releases/editor/alpha/6000.5.0a3#notes
