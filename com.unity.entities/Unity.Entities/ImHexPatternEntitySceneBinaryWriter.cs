...
namespace Unity.Entities
{
    public struct ImHexPatternEntitySceneBinaryWriter : IDisposable
    {
        ...
        static TypeBucket GetTypeBucket(Type type)
        {
            ...
            {
                not null when type.Namespace.StartsWith("Unity") => TypeBucket.Unity,
                not null when type.Namespace.StartsWith("System") => TypeBucket.System,
                _ => TypeBucket.User
            };
        }
