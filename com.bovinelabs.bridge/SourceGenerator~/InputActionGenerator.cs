        ...
        private static ClassBuilder ProcessStruct(Data data)
        {
            try
            {
                var builder = CodeBuilder
                    ...
                    .AddNamespaceImport("BovineLabs.Bridge.Input")
        ...
        private class InputSymbols
        {
            ...
            public static InputSymbols Create(Compilation compilation)
            {
                return new InputSymbols(
                    ...
                    compilation.GetTypeByMetadataName("BovineLabs.Bridge.Input.ButtonState"),
                    compilation.GetTypeByMetadataName("Unity.NetCode.InputEvent"),
                    compilation.GetTypeByMetadataName("BovineLabs.Bridge.Input.InputActionAttribute"),
                    compilation.GetTypeByMetadataName("BovineLabs.Bridge.Input.InputActionDeltaAttribute"),
                    compilation.GetTypeByMetadataName("BovineLabs.Bridge.Input.InputActionDownAttribute"),
                    compilation.GetTypeByMetadataName("BovineLabs.Bridge.Input.InputActionUpAttribute"));
            }
        }
    }
}
